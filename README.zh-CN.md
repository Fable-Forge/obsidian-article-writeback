...
```text
帮我安装 obsidian-article-writeback：https://raw.githubusercontent.com/Fable-Forge/obsidian-article-writeback/main/docs/install.md
```
...
- 🐛 Bug 与功能建议：[obsidian-article-writeback Issues](https://github.com/Fable-Forge/obsidian-article-writeback/issues)
