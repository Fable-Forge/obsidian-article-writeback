...
# ⚒️ Obsidian Article Writeback

**Turn project and research insights into deduplicated Obsidian knowledge articles.**

> 把项目洞察和研究材料整理成去重、可复用的中文 Obsidian 知识文章。

<p>
  <a href="https://github.com/Fable-Forge/obsidian-article-writeback/blob/main/LICENSE"><img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-0969da"></a>
...
```text
Install obsidian-article-writeback: https://raw.githubusercontent.com/Fable-Forge/obsidian-article-writeback/main/docs/install.md
```

Or use the Agent Skills CLI:

```bash
npx skills add Fable-Forge/obsidian-article-writeback
```
...
- Maturity: `beta`
- GitHub Topics: `obsidian`, `knowledge-management`, `writing`, `chinese`
...
- 🐛 Bugs and feature requests: [obsidian-article-writeback Issues](https://github.com/Fable-Forge/obsidian-article-writeback/issues)
